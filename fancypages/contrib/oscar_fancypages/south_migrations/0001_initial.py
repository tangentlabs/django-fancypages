...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'oscar_fancypages', ['SingleProductBlock'])

        # Adding model 'HandPickedProductsPromotionBlock'
        db.create_table(u'oscar_fancypages_handpickedproductspromotionblock', (
            (u'contentblock_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fancypages.ContentBlock'], unique=True, primary_key=True)),
            ('promotion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.HandPickedProductList'], null=True)),
        ))
        db.send_create_signal(u'oscar_fancypages', ['HandPickedProductsPromotionBlock'])

        # Adding model 'AutomaticProductsPromotionBlock'
        db.create_table(u'oscar_fancypages_automaticproductspromotionblock', (
            (u'contentblock_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fancypages.ContentBlock'], unique=True, primary_key=True)),
            ('promotion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.AutomaticProductList'], null=True)),
        ))
        db.send_create_signal(u'oscar_fancypages', ['AutomaticProductsPromotionBlock'])

        # Adding model 'OfferBlock'
        db.create_table(u'oscar_fancypages_offerblock', (
            (u'contentblock_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fancypages.ContentBlock'], unique=True, primary_key=True)),
            ('offer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offer.ConditionalOffer'], null=True)),
        ))
        db.send_create_signal(u'oscar_fancypages', ['OfferBlock'])

        # Adding model 'PrimaryNavigationBlock'
        db.create_table(u'oscar_fancypages_primarynavigationblock', (
            (u'contentblock_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fancypages.ContentBlock'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'oscar_fancypages', ['PrimaryNavigationBlock'])


    def backwards(self, orm):
        # Deleting model 'SingleProductBlock'
        db.delete_table(u'oscar_fancypages_singleproductblock')

        # Deleting model 'HandPickedProductsPromotionBlock'
        db.delete_table(u'oscar_fancypages_handpickedproductspromotionblock')

        # Deleting model 'AutomaticProductsPromotionBlock'
        db.delete_table(u'oscar_fancypages_automaticproductspromotionblock')

        # Deleting model 'OfferBlock'
        db.delete_table(u'oscar_fancypages_offerblock')

        # Deleting model 'PrimaryNavigationBlock'
        db.delete_table(u'oscar_fancypages_primarynavigationblock')
    ...
    models = {
        ...
        u'oscar_fancypages.automaticproductspromotionblock': {
            ...
            'promotion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['promotions.AutomaticProductList']", 'null': 'True'})
        },
        u'oscar_fancypages.handpickedproductspromotionblock': {
            'Meta': {'ordering': "['display_order']", 'object_name': 'HandPickedProductsPromotionBlock', '_ormbases': ['fancypages.ContentBlock']},
            u'contentblock_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['fancypages.ContentBlock']", 'unique': 'True', 'primary_key': 'True'}),
            'promotion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['promotions.HandPickedProductList']", 'null': 'True'})
        },
        u'oscar_fancypages.offerblock': {
            'Meta': {'ordering': "['display_order']", 'object_name': 'OfferBlock', '_ormbases': ['fancypages.ContentBlock']},
            u'contentblock_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['fancypages.ContentBlock']", 'unique': 'True', 'primary_key': 'True'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['offer.ConditionalOffer']", 'null': 'True'})
        },
        u'oscar_fancypages.primarynavigationblock': {
            'Meta': {'ordering': "['display_order']", 'object_name': 'PrimaryNavigationBlock', '_ormbases': ['fancypages.ContentBlock']},
            u'contentblock_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['fancypages.ContentBlock']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'oscar_fancypages.singleproductblock': {
            'Meta': {'ordering': "['display_order']", 'object_name': 'SingleProductBlock', '_ormbases': ['fancypages.ContentBlock']},
            u'contentblock_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['fancypages.ContentBlock']", 'unique': 'True', 'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Product']", 'null': 'True'})
        },
    ...
    complete_apps = ['oscar_fancypages']

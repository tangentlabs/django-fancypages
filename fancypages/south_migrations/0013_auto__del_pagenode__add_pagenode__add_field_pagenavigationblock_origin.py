...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageNavigationBlock.origin'
        db.add_column(u'fancypages_pagenavigationblock', 'origin',
                      self.gf('django.db.models.fields.CharField')(default=u'absolute', max_length=50),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PageNavigationBlock.origin'
        db.delete_column(u'fancypages_pagenavigationblock', 'origin')

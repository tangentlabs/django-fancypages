...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fancypages_pagenavigationblock', 'depth',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'fancypages_pagenavigationblock', 'depth')

        # Deleting field 'PageNavigationBlock.is_relative'
        db.delete_column(u'fancypages_pagenavigationblock', 'is_relative')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FancyPage.uuid'
        db.add_column('fancypages_fancypage', 'uuid',
                      self.gf('shortuuidfield.fields.ShortUUIDField')(db_index=True, default='', max_length=22, blank=True),
                      keep_default=False)

        # Adding field 'PageType.uuid'
        db.add_column('fancypages_pagetype', 'uuid',
                      self.gf('shortuuidfield.fields.ShortUUIDField')(db_index=True, default='', max_length=22, blank=True),
                      keep_default=False)

        # Adding field 'PageGroup.uuid'
        db.add_column('fancypages_pagegroup', 'uuid',
                      self.gf('shortuuidfield.fields.ShortUUIDField')(db_index=True, default='', max_length=22, blank=True),
                      keep_default=False)

        # Adding field 'Container.uuid'
        db.add_column('fancypages_container', 'uuid',
                      self.gf('shortuuidfield.fields.ShortUUIDField')(db_index=True, default='', max_length=22, blank=True),
                      keep_default=False)

        # Adding field 'ContentBlock.uuid'
        db.add_column('fancypages_contentblock', 'uuid',
                      self.gf('shortuuidfield.fields.ShortUUIDField')(db_index=True, default='', max_length=22, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FancyPage.uuid'
        db.delete_column('fancypages_fancypage', 'uuid')

        # Deleting field 'PageType.uuid'
        db.delete_column('fancypages_pagetype', 'uuid')

        # Deleting field 'PageGroup.uuid'
        db.delete_column('fancypages_pagegroup', 'uuid')

        # Deleting field 'Container.uuid'
        db.delete_column('fancypages_container', 'uuid')

        # Deleting field 'ContentBlock.uuid'
        db.delete_column('fancypages_contentblock', 'uuid')
